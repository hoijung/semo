$(document).ready(function () {
			...
			$('.menu-container').load('menu.html', function () {
				...
				if (menuBar) {
					...
					const currentPageMenuItem = menuBar.querySelector('[data-page="logistList_2.html"]');
			...
			$('#btnSearch').on('click', function () {
				table.ajax.url('/api/print-info/list2?' + $('#searchForm').serialize()).load();
			});
